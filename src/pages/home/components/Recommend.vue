<template>
	<div>
		...
		<ul>
			<li class="item border-bottom" v-for="item of recommednList">
				...
				<div class="item-info">
					...
					<button class="item-button">查看详情text</button>
				</div>
			</li>
